...
const ProductDetails = ({limit=[250]}) => {
    ...
    <div className='container mx-auto p-4'>
      ...
      <div className='min-h-[200px] flex flex-col lg:flex-row gap-4'>
          ...
          <div className='h-96 flex flex-col lg:flex-row-reverse gap-4'>
              ...
              <div className='h-[300px] w-[300px] lg:h-96 lg:w-96 bg-slate-200 relative p-2 like'>
            ...
            (
              <div className='flex flex-col gap-1'>
                ...
                <div>
                  ...
                  <div className='read-more-read-less'>{isReadMoreShown ? data?.description : data?.description.substr(0, limit)}
                  <button className='btn' onClick={toggleBtn}>{isReadMoreShown ? 'Read Less' : '...Read More'}</button></div>
                </div>
              </div>
            )
           }
